...
test.describe('North Carolina Election Atlas regression checks', () => {
  ...
  test('2026 modeled Senate and Supreme Court contests synthesize county and district slices', async ({ page }) => {
    ...
    expect(modeledSnapshot.nashCountyOfficialMargin).toBeLessThan(3);
    expect(modeledSnapshot.nashCountyOfficialMargin).toBeGreaterThan(-3);
    expect(modeledSnapshot.nashLocalCandidateEffect).toBeCloseTo(5.10, 2);
    expect(modeledSnapshot.wilsonCountyOfficialMargin).toBeLessThan(3);
    expect(modeledSnapshot.wilsonCountyOfficialMargin).toBeGreaterThan(-3);
    expect(modeledSnapshot.wilsonLocalCandidateEffect).toBeCloseTo(1.60, 2);
    ...
    expect(modeledSnapshot.ruralCooperBoost).toBeCloseTo(0.28, 2);
