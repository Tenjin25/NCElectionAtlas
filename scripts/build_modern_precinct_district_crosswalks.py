...
DEFAULT_SPECS = [
    ...
    DistrictCrosswalkSpec(
        ...
        assignment_path=ROOT / "data/crosswalks/ncga_sl2023_149_house_block_assignments.csv",
        block_col="Block",
        district_col="District",
        district_type="state_house",
        target_year=2024,
        plan_id="sl_2023_149",
        plan_label="SL 2023-149 House Lines (block-weighted December 2025 precinct basis)",
        district_width=3,
        district_prefix="HD",
        district_name_template="State House District {number}",
    ),
    DistrictCrosswalkSpec(
        ...
        assignment_path=ROOT / "data/crosswalks/ncga_sl2023_146_senate_block_assignments.csv",
        block_col="Block",
        district_col="District",
        district_type="state_senate",
        target_year=2024,
        plan_id="sl_2023_146",
        plan_label="SL 2023-146 Senate Lines (block-weighted December 2025 precinct basis)",
        district_width=2,
        district_prefix="SD",
        district_name_template="State Senate District {number}",
    ),
