#!/usr/bin/env python3
"""Promote all geographically validated 2004 full-ballot district files."""
...
AUDIT = ROOT / "data/reports/urban_sf1_historical/full_ballot_2004_audit.json"
STAGING = {
...
BACKUP = ROOT / "data/reports/urban_sf1_historical/pre_promotion_full_ballot_2004"
MANIFEST = ROOT / "data/reports/urban_sf1_historical/promotion_full_ballot_2004.json"
...
def main() -> None:
    ...
    if len(candidates) != 102:
        raise RuntimeError(
            f"Expected 102 audited 2004 promotion candidates; found {len(candidates)}"
        )
    ...
    payload = {
        "schema": "urban_sf1_2004_full_ballot_promotion.v1",
