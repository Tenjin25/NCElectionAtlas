...
- Left Wake, Mecklenburg, and Cabarrus out of the more aggressive county-by-county official-name backfill pass on purpose: Wake and Mecklenburg are the two most populous counties in North Carolina, and Cabarrus is a major Charlotte spillover county. All three are changing and re-precincting quickly enough that hand-maintaining a fully current source-backed naming layer across election cycles would likely go stale almost immediately.
